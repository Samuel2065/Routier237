...
<body>
    ...
    <div class="main-content">
        <div class="top-bar">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <small class="text-muted">Welcome back, {{ $dashboardUserName }}</small>
                </div>
                <div class="dropdown">
                    <form method="POST" action="{{ route('profile.photo.update') }}" enctype="multipart/form-data" id="profilePhotoFormCustomer" class="d-none">
                        @csrf
                        <input type="file" id="profilePhotoInputCustomer" name="photo" accept="image/*" onchange="this.form.submit()">
                    </form>
                    <button class="profile-trigger dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="profile-avatar-wrap" onclick="event.preventDefault(); event.stopPropagation(); document.getElementById('profilePhotoInputCustomer').click();">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end profile-menu">
                        ...
                        <li><a class="dropdown-item" href="{{ route('customer.profile') }}"><i class="bi bi-person me-2"></i> Mon Profil</a></li>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <p class="mb-1 text-muted">Upcoming Trips</p>
                <h3>{{ $stats['upcoming_trips'] }}</h3>
            </div>
            <div class="stat-card">
        ...
        <div class="content-card">
            ...
            @forelse($recentBookings as $booking)
                <div class="d-flex justify-content-between border-bottom py-2">
                    <span>
                        {{ optional($booking->trip)->departure_city ?? 'N/A' }} -> {{ optional($booking->trip)->arrival_city ?? 'N/A' }}
                    </span>
